...
pub enum Stmt {
    ...
    ConstDeclaration(String, Expr),       // nome, valor obrigatório
    Assignment(String, Expr),             // nome, valor
    PropertyAssignment(Expr, String, Expr), // object, property, value
    IndexAssignment(Expr, Expr, Expr),    // array/object, index, value
    ...
    AsyncFunctionDeclaration(String, Vec<String>, Box<Stmt>), // async function name(params...) { body }
    ThreadFunctionDeclaration(String, Vec<String>, Box<Stmt>), // thread function name(params...) { body }
...
pub enum ClassMember {
    ...
    AsyncMethod(Visibility, bool, String, Vec<String>, Box<Stmt>), // visibility, is_static, name, params, body
