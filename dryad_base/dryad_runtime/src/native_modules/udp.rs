...
pub fn register_udp_functions(functions: &mut HashMap<String, fn(&[Value]) -> Result<Value, RuntimeError>>) {
    // Servidor UDP
...
fn native_udp_server_create(args: &[Value]) -> Result<Value, RuntimeError> {
...
fn native_udp_server_start(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 1 {
...
fn native_udp_server_stop(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 1 {
...
fn native_udp_server_status(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 1 {
...
fn native_udp_client_create(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.is_empty() || args.len() > 3 {
...
fn native_udp_client_bind(args: &[Value]) -> Result<Value, RuntimeError> {
...
fn native_udp_client_send(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 2 {
...
fn native_udp_client_receive(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 1 {
...
fn native_udp_client_send_to(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 4 {
...
fn native_udp_client_receive_from(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 1 {
...
fn native_udp_client_status(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 1 {
...
fn native_udp_client_set_timeout(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 2 {
...
/// Fecha o cliente UDP
fn native_udp_client_close(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 1 {
...
fn native_udp_resolve_hostname(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 1 {
...
fn native_udp_get_local_ip(args: &[Value]) -> Result<Value, RuntimeError> {
    if !args.is_empty() {
...
fn native_udp_port_available(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 1 {
