...
fn native_debug(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
pub fn register_debug_functions(functions: &mut HashMap<String, fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>>) {
...
// Log simples
fn native_log(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 2 {
...
fn native_typeof(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
// Uso de memória
fn native_memory_usage(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if !args.is_empty() {
...
// Stack trace
fn native_stack_trace(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if !args.is_empty() {
...
fn native_perf_start(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
fn native_perf_end(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
// Assert genérico
fn native_assert(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
// Assert igualdade
fn native_assert_equal(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_assert_not_equal(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() < 2 || args.len() > 3 {
...
// Assert true
fn native_assert_true(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() < 1 || args.len() > 2 {
...
// Assert false
fn native_assert_false(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() < 1 || args.len() > 2 {
...
// Assert tipo
fn native_assert_type(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() < 2 || args.len() > 3 {
...
// Testar regex
fn native_test_regex(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 2 {
