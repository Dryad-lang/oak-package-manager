...
pub fn register_binary_io_functions(functions: &mut HashMap<String, fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>>) {
    functions.insert("native_write_bytes".to_string(), native_write_bytes as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_append_bytes".to_string(), native_append_bytes as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_overwrite_chunk".to_string(), native_overwrite_chunk as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_read_bytes".to_string(), native_read_bytes as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_read_chunk".to_string(), native_read_chunk as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_file_size".to_string(), native_file_size as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
...
/// Retorna: null
fn native_write_bytes(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 2 {
...
fn native_to_hex(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
/// Entrada: path (string), bytes (array)
/// Retorna: null
fn native_append_bytes(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 2 {
        return Err(RuntimeError::ArgumentError(
...
/// Retorna: null
fn native_overwrite_chunk(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 3 {
        return Err(RuntimeError::ArgumentError(
...
fn native_read_bytes(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
        return Err(RuntimeError::ArgumentError(
...
/// Retorna: array de bytes
fn native_read_chunk(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 3 {
        return Err(RuntimeError::ArgumentError(
...
fn native_file_size(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
        return Err(RuntimeError::ArgumentError(
