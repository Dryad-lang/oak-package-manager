...
pub fn register_system_env_functions(map: &mut HashMap<String, fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>>) {
...
fn native_platform(_args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_arch(_args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_env(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
/// Retorna: nenhum
fn native_set_env(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 2 {
...
fn native_exec(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
fn native_exec_output(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
fn native_pid(_args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_exit(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_getcwd(_args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
