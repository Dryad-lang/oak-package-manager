...
fn native_clear_screen(_args: &[Value]) -> Result<Value, RuntimeError> {
...
fn native_move_cursor(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 2 {
...
fn native_set_color(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 2 {
        return Err(RuntimeError::ArgumentError(
...
fn native_set_style(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 1 {
        return Err(RuntimeError::ArgumentError(
...
fn native_reset_style(_args: &[Value]) -> Result<Value, RuntimeError> {
...
fn native_hide_cursor(_args: &[Value]) -> Result<Value, RuntimeError> {
...
fn native_show_cursor(_args: &[Value]) -> Result<Value, RuntimeError> {
...
fn native_terminal_size(_args: &[Value]) -> Result<Value, RuntimeError> {
...
fn native_ansi_red(args: &[Value]) -> Result<Value, RuntimeError> {
    if args.len() != 1 {
