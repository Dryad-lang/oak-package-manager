...
pub fn register_http_client_functions(functions: &mut HashMap<String, fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>>) {
...
fn native_http_get(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_post(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    let url = match &args[0] {
        RuntimeValue::String(s) => s,
...
fn native_http_headers(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    let url = match &args[0] {
        RuntimeValue::String(s) => s,
...
fn native_http_download(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    let url = match &args[0] {
        RuntimeValue::String(s) => s,
...
fn native_http_status(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    let url = match &args[0] {
        RuntimeValue::String(s) => s,
...
fn native_http_json(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    let url = match &args[0] {
        RuntimeValue::String(s) => s,
...
fn native_http_set_timeout(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_headers(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_user_agent(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_proxy(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_auth(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_follow_redirects(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_cache(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_compression(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_max_redirects(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_retry(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_cookies(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_keepalive(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_reuseaddr(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_nodelay(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_ssl_verify(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_ssl_cert(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_ssl_key(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_ssl_ca(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_ssl_sni(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_ssl_protocols(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_ssl_ciphers(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
...
fn native_http_set_ssl_session(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
