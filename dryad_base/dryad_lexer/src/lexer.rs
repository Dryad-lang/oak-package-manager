...
impl Lexer {
    ...
    fn identifier(&mut self) -> Result<Token, DryadError> {
        ...
        let token = match text.as_str() {
            "let" | "const" | "if" | "else" | "function" | "class" | "return" | "for" | "while" | "do" | "break" | "continue" | "import" | "export" | "use" | "try" | "catch" | "finally" | "throw" | "in" | "this" | "super" | "static" | "public" | "private" | "protected" | "extends" | "async" | "await" | "thread" | "mutex" => {
                Token::Keyword(text)
            },
